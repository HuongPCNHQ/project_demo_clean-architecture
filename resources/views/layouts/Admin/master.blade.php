                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <ul class="menu-nav">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/admin/list-user" class="menu-link">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/admin/add-user" class="menu-link">
                                                <i class="menu-bullet menu-bullet-line">
                                                    <span></span>
                                                </i>
                            ...
                            <!-- <li class="menu-item" aria-haspopup="true">
                                <a href="/show-log" class="menu-link">
                                    <i class="menu-icon flaticon2-graph-1"></i>
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-end">
                        ...
                        <div class="topbar">
                            <style>
                                ...
                                .btnAuth:hover {
                                    background-color: #058f88ff !important;
                                    border-radius: 0.42rem;
                                }
                            </style>
                            <div class="topbar-item">
                                <div class="update-hover"
                                    id="">
                                    <Button id="btn-login" class="btnAuth">Đăng xuất</Button>
                                </div>
                            </div>
