    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            <div class="d-flex align-items-center" id="kt_subheader_search">
                <form class="ml-5">
                    <div class="input-group input-group-sm input-group-solid" style="max-width: 300px;height: 48px;">
                        <input type="text" class="form-control" id="kt_subheader_search_form" placeholder="Search..." />
                        <button class="input-group-append" style="padding: 8px 0;border-radius: 10px;">
            ...
            <div class="dropdown dropdown-inline mr-2">
                ...
                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi flex-column navi-hover py-2">
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="navi-text">Support</span>
                            </a>
                        </li>
                    </ul>
                    <!--end::Navigation-->
            ...
            <div class="dropdown dropdown-inline mr-2">
                ...
                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi flex-column navi-hover py-2">
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="navi-text">Actived</span>
                            </a>
                        </li>
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="navi-text">Not Actived</span>
                            </a>
                        </li>
                    </ul>
                    <!--end::Navigation-->
                ...
                <tbody id="users-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <button style="height:23px;border:none;cursor: default;" class="color-option"></button>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg"></span>
                        </td>
                        <td>
                            <button id="btnLockAndUnlock" type="button" data-id="${user.id}" style="height:23px;border:none;" class="color-option">
                                </button>
                        </td>
